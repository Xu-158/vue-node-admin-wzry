module.exports = app => {
  ...
  router.get('/heroes/list', async (req, res) => {
    ...
    const subCats = cats.map(v => v._id)
    // await cats.deleteMany({name:"英雄分类"})
    cats.shift()
    cats.unshift({
      name: '热门',
